...
export default function QuestionConfigForm({ type, config, updateConfig }) {
  ...
  const componentsMap = {
    ...
    [QUESTION_TYPES.DROPDOWN]: <OptionsConfig config={config} updateConfig={updateConfig} />,
    [QUESTION_TYPES.CHECKBOX]: <OptionsConfig config={config} updateConfig={updateConfig} />,
