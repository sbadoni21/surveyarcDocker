          ...
          <div className="space-y-3">
            <div className="flex gap-1 items-center">
              ...
              <div className="w-full">
                <InfoRow label="Organization Name" value={data?.name} isMono />
              </div>
            </div>
            <div className="flex gap-1 items-center">
              <Icon
              ...
              />
              <div className="w-full">
                <InfoRow label="Owner Email" value={data?.owner_email} isMono />
              </div>
            </div>
            <div className="flex gap-1 items-center">
              <Icon
                ...
                <InfoRow
                  ...
                  value={
                    data?.subscription?.endDate
                      ? new Date(data.subscription.endDate).toLocaleString(
                          "en-US",
                          {
                            year: "numeric",
                            month: "long",
