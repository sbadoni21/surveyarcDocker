...
// GET /api/post-gres-apis/contact-lists/[listId]
export async function GET(req, { params }) {
  const { listId } = await params;

  try {
    const res = await fetch(`${BASE}/contact-lists/${encodeURIComponent(listId)}`, {
...
// PATCH /api/post-gres-apis/contact-lists/[listId]
...
// DELETE /api/post-gres-apis/contact-lists/[listId]
