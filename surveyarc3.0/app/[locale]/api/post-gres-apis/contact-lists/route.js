...
// GET /api/post-gres-apis/contact-lists?org_id=xxx
export async function GET(req) {
  ...
  try {
    const res = await fetch(`${BASE}/contact-lists?org_id=${encodeURIComponent(org_id)}`, { 
...
// POST /api/post-gres-apis/contact-lists
