...
// GET /api/post-gres-apis/campaign-results/[result_id]
export async function GET(req, { params }) {
  try {
    ...
    if (!result_id) {
      return NextResponse.json(
        { status: "error", message: "Missing result_id" },
        { status: 400 }
      );
    }

    const url = `${BASE}/campaign-results/${encodeURIComponent(result_id)}`;
...
// PATCH /api/post-gres-apis/campaign-results/[result_id]
