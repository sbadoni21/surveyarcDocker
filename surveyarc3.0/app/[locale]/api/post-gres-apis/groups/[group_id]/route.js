// app/en/api/post-gres-apis/groups/[group_id]/route.js
...
// GET /en/api/post-gres-apis/groups/[group_id]
export async function GET(req, { params }) {
  try {
    ...
    const res = await fetch(`${BASE}/groups/${params.group_id}`, {
      headers: {
        ...(ENC ? { "x-encrypted": "1" } : {}),
...
// PATCH /en/api/post-gres-apis/groups/[group_id]
...
// DELETE /en/api/post-gres-apis/groups/[group_id]
