// app/en/api/post-gres-apis/groups/[group_id]/members/route.js
...
// GET /en/api/post-gres-apis/groups/[group_id]/members
export async function GET(req, { params }) {
  try {
    ...
    const res = await fetch(`${BASE}/groups/${params.group_id}/members`, {
      headers: {
        ...(ENC ? { "x-encrypted": "1" } : {}),
...
// POST /en/api/post-gres-apis/groups/[group_id]/members
