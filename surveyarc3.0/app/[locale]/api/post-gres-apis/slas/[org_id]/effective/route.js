// app/api/post-gres-apis/slas/[org_id]/effective/route.js
...
export async function GET(req, { params }) {
  ...
  ["at_time", "scope"].forEach((k) => {
    const v = searchParams.get(k);
    if (v !== null && v !== undefined && v !== "") qs.set(k, v);
  });

  try {
    const res = await fetch(`${BASE}/slas/${encodeURIComponent(org_id)}/effective?${qs.toString()}`, {
