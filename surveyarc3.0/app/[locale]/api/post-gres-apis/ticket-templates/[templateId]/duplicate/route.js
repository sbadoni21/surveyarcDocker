...
// app/api/post-gres-apis/ticket-templates/[template_id]/duplicate/route.js
export async function POST(req, { params }) {
  try {
    ...
    const res = await fetch(
      `${BASE}/ticket-templates/templates/${templateId}/duplicate?new_name=${encodeURIComponent(newName)}`,
      {
        method: "POST",
        headers: {
