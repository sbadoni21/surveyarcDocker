// app/api/post-gres-apis/tickets/[ticket_id]/teams/route.js
...
/**
 * POST mutate teams on ticket
 * body: { team_ids: string[], mode?: "add" | "replace" | "remove" }
 * default mode = "add"
 */
export async function POST(req, { params }) {
  ...
  try {
    ...
    const res = await fetch(`${BASE}/tickets/${encodeURIComponent(ticket_id)}/teams`, {
      method: "POST",
