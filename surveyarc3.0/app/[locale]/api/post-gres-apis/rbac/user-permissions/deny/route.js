// app/api/post-gres-apis/rbac/user-permissions/deny/route.js
...
export async function POST(req) {
  try {
    ...
    console.log("[User Permissions] Deny request:", body);
    ...
    const res = await fetch(`${BASE}/rbac/user-permissions/deny`, {
      method: "POST",
      headers: {
    ...
    console.error("[User Permissions] Deny error:", e);
    return NextResponse.json(
