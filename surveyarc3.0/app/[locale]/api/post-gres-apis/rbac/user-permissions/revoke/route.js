// app/api/post-gres-apis/rbac/user-permissions/revoke/route.js
...
export async function POST(req) {
  try {
    ...
    console.log("[User Permissions] Revoke request:", body);
    ...
    const res = await fetch(`${BASE}/rbac/user-permissions/revoke`, {
      method: "POST",
      headers: {
    ...
    console.error("[User Permissions] Revoke error:", e);
    return NextResponse.json(
