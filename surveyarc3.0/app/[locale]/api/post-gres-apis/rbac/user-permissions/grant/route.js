// app/api/post-gres-apis/rbac/user-permissions/grant/route.js
...
export async function POST(req) {
  try {
    ...
    console.log("[User Permissions] Grant request:", body);
    ...
    const res = await fetch(`${BASE}/rbac/user-permissions/grant`, {
      method: "POST",
      headers: {
    ...
    console.error("[User Permissions] Grant error:", e);
    return NextResponse.json(
