// app/api/post-gres-apis/rbac/user-permissions/user/[userId]/denials/route.js
...
export async function GET(req, { params }) {
  try {
    ...
    const url = new URL(`${BASE}/rbac/user-permissions/user/${userId}/denials`);
    ...
    console.log("[User Permissions] Fetching denials:", url.toString());
