// app/api/post-gres-apis/rbac/user-permissions/user/[userId]/custom-grants/route.js
...
export async function GET(req, { params }) {
  try {
    ...
    const url = new URL(`${BASE}/rbac/user-permissions/user/${userId}/custom-grants`);
    ...
    console.log("[User Permissions] Fetching custom grants:", url.toString());
