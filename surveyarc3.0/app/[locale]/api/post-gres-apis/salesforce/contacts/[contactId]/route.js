...
// GET /api/post-gres-apis/salesforce/contacts/[contactId]
export async function GET(req, { params }) {
  const { contactId } = await params;

  try {
    const res = await fetch(
      `${BASE}/salesforce/contacts/${encodeURIComponent(contactId)}`,
      {
...
// PATCH /api/post-gres-apis/salesforce/contacts/[contactId]
...
// DELETE /api/post-gres-apis/salesforce/contacts/[contactId]
